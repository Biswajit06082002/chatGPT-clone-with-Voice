  ...
  return (
   <main className="chatGPT-app">
    <section className="chat-container">
      <div className="navbar">Marcos chatGPT clone</div>
    ...
    <footer>
      <input value={input} className="composebar" autoFocus type="text" placeholder="enter Your Curiosity...!" onChange={(e)=>setInput(e.target.value)} 
      onKeyUp={onKeyUp}/>
